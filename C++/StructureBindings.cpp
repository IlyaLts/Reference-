// Structure Bindings requires C++ 17
...
int main()
{
    ...
    // Structure binding concept used position and success are used in place of first and second
    auto[process, success] = fav_lang.insert({ "Henry", "Golang" });
   
    // Check boolean value of success
    if (success) cout << "Insertion done!!" << endl;
